...
export interface LiveOrder { id:string; customerName:string; maskedPhone:string|null; purchaseAt:Date|null; total:number; channel:string; products:Array<{name:string;amount:number}>; brand:OrderBrand; eligible:boolean; reason:string|null; status:string; }
